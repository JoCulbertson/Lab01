package com.example.willow.simpletimer;
...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    public void onClick(View view) {
        if(!timerHasStarted) {
            ...
            startB.setText(getResources().getString(R.string.reset_button));
        }
    }
    ...
    public class MainCountDownTimer extends CountDownTimer {
        ...
        public void onFinish() {
            text.setText(getResources().getString(R.string.finished));
